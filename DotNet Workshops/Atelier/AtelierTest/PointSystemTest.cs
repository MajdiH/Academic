...
namespace AtelierTest
{
    ...
    /// <summary>
    ///Classe de test pour PointSystemTest, destinée à contenir tous
    ///les tests unitaires PointSystemTest
    ///</summary>
    [TestClass()]
    public class PointSystemTest
    {
        ...
        internal virtual PointSystem CreatePointSystem()
        {
            // TODO: instanciez une classe concrète appropriée.
            PointSystem target = null;
            return target;
        }
